...
function fun3(str1:string,str2:string){
    console.log(str1+str2)
}
fun3("Function with parameter ",'& without Return type');

function fun4(str1:string,str2:string):string{
    return(str1+str2)
}
...
var temp3=function(str1:string,str2:string){
    console.log(str1+str2)
}
temp3("Function with parameter ",'& without Return type');

var temp4=function(str1:string,str2:string):string{
    return(str1+str2)
}
